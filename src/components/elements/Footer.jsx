...
function Footer() {
  return (
    <footer className="bg-primary-neutral-900 rounded-t-2xl mt-16 bg-pattern-dark">
      <Container>
        <div className="flex flex-col items-center pt-12 pb-16">
            <Headline className="text-center text-primary-neutral-100 mt-12 lg:text-center lg:w-[600px] lg:mx-auto">Ready to debug your reading list?</Headline>
        ...
        <div className="flex flex-col justify-center items-center py-6 gap-4 md:flex-row md:justify-between">
