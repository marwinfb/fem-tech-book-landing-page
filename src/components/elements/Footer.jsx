...
function Footer() {
  return (
    <footer className="bg-primary-neutral-900 rounded-2xl mt-16">
      <Container>
        ...
        <div className="flex flex-col justify-center items-center py-6 gap-4">
          <small className="font-normal text-sm leading-[1.2] tracking-[-1px] text-primary-neutral-000">© 2024 – Tech Book Club</small>
