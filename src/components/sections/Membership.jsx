        ...
        <Container>
            ...
            <div className="mt-6 grid grid-cols-1 gap-6">
                {membershipCardsData.map((card, index)=> (
                    <div key={index} className="p-6 rounded-lg border border-neutral-200 space-y-8">
                        <div className="space-y-6 text-xl font-normal leading-[1.4] tracking-[-.5px] text-primary-neutral-700">
