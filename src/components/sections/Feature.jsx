  ...
  return (
    <section>
        <Container className="space-y-16">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-x-20 lg:gap-y-30">
                ...
                <div className="relative">
                    ...
                    <img src={images.logos_tech} className="absolute bottom-14 right-14 lg:-left-14" alt="Tech Logos" />
                </div>
            </div>
        </Container>
    </section>
